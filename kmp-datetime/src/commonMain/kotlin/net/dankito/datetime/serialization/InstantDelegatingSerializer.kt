 ...
 * - [InstantSerializationFormat.EpochNanoseconds] -> delegates to [InstantEpochNanosecondsSerializer]
...
object InstantDelegatingSerializer: KSerializer<Instant> {
    ...
    private fun getSerializer(): KSerializer<Instant> = when (SerializationConfig.InstantDefaultFormat) {
        ...
        InstantSerializationFormat.EpochNanoseconds -> InstantEpochNanosecondsSerializer
