...
open class InstantDelegatingJacksonDeserializer : StdDeserializer<Instant>(Instant::class.java) {
    ...
    private fun getDeserializer(): StdDeserializer<Instant> = when (SerializationConfig.InstantDefaultFormat) {
        ...
        InstantSerializationFormat.EpochNanoseconds -> InstantEpochNanosecondsJacksonDeserializer.Instance
        InstantSerializationFormat.EpochSecondsAsDouble -> InstantEpochSecondsAsDoubleJacksonDeserializer.Instance
